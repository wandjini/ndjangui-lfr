 ...
 * @generated
 */
public abstract class SanctionActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SanctionActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SanctionLocalServiceUtil.getService());
		setClass(Sanction.class);

		setClassLoader(cmr.fandenatech.ndjangui.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("sanctionId");
	}
}