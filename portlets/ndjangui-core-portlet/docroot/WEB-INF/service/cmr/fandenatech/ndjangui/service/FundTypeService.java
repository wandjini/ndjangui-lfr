...
/**
 * Provides the remote service interface for FundType. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author guyw
 * @see FundTypeServiceUtil
...
public interface FundTypeService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link FundTypeServiceUtil} to access the fund type remote service. Add custom service methods to {@link cmr.fandenatech.ndjangui.service.impl.FundTypeServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
