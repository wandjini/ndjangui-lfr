 ...
 * @generated
 */
public abstract class FundTypeActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public FundTypeActionableDynamicQuery() throws SystemException {
		setBaseLocalService(FundTypeLocalServiceUtil.getService());
		setClass(FundType.class);

		setClassLoader(cmr.fandenatech.ndjangui.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("fundTypeId");
	}
}