...
/**
 * Provides the remote service interface for SanctionType. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author guyw
 * @see SanctionTypeServiceUtil
...
public interface SanctionTypeService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SanctionTypeServiceUtil} to access the sanction type remote service. Add custom service methods to {@link cmr.fandenatech.ndjangui.service.impl.SanctionTypeServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
