...
/**
 * The persistence utility for the member fund service. This utility wraps {@link MemberFundPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class MemberFundUtil {
	 ...
	 */
	public static void clearCache(MemberFund memberFund) {
		getPersistence().clearCache(memberFund);
	}
	 ...
	 */
	public static List<MemberFund> findWithDynamicQuery(
	 ...
	 */
	public static MemberFund update(MemberFund memberFund)
		throws SystemException {
		return getPersistence().update(memberFund);
	}
	...
	public static MemberFund update(MemberFund memberFund,
		...
		return getPersistence().update(memberFund, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(memberFund);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(memberFunds);
	}
	...
	*/
	public static cmr.fandenatech.ndjangui.model.MemberFund create(
		long memberFundId) {
	...
	*/
	public static cmr.fandenatech.ndjangui.model.MemberFund remove(
		long memberFundId)
	...
	public static cmr.fandenatech.ndjangui.model.MemberFund updateImpl(
		cmr.fandenatech.ndjangui.model.MemberFund memberFund)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(memberFund);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static cmr.fandenatech.ndjangui.model.MemberFund findByPrimaryKey(
		long memberFundId)
		throws cmr.fandenatech.ndjangui.NoSuchMemberFundException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static cmr.fandenatech.ndjangui.model.MemberFund fetchByPrimaryKey(
		long memberFundId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<cmr.fandenatech.ndjangui.model.MemberFund> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static MemberFundPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (MemberFundPersistence)PortletBeanLocatorUtil.locate(cmr.fandenatech.ndjangui.service.ClpSerializer.getServletContextName(),
					MemberFundPersistence.class.getName());

			ReferenceRegistry.registerReference(MemberFundUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(MemberFundPersistence persistence) {
	}

	private static MemberFundPersistence _persistence;
}