...
/**
 * Provides the local service interface for MemberSitting. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author guyw
 * @see MemberSittingLocalServiceUtil
...
public interface MemberSittingLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MemberSittingLocalServiceUtil} to access the member sitting local service. Add custom service methods to {@link cmr.fandenatech.ndjangui.service.impl.MemberSittingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
