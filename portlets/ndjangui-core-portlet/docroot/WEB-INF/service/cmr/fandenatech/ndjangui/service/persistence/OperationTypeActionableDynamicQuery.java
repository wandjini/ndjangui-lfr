 ...
 * @generated
 */
public abstract class OperationTypeActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public OperationTypeActionableDynamicQuery() throws SystemException {
		setBaseLocalService(OperationTypeLocalServiceUtil.getService());
		setClass(OperationType.class);

		setClassLoader(cmr.fandenatech.ndjangui.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("operationTypeId");
	}
}