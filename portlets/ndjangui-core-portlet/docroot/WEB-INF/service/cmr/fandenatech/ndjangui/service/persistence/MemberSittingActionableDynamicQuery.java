 ...
 * @generated
 */
public abstract class MemberSittingActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public MemberSittingActionableDynamicQuery() throws SystemException {
		setBaseLocalService(MemberSittingLocalServiceUtil.getService());
		setClass(MemberSitting.class);

		setClassLoader(cmr.fandenatech.ndjangui.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("memberSittingId");
	}
}