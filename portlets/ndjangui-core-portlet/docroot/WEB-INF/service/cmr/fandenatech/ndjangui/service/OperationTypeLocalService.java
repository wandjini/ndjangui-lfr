...
/**
 * Provides the local service interface for OperationType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author guyw
 * @see OperationTypeLocalServiceUtil
...
public interface OperationTypeLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OperationTypeLocalServiceUtil} to access the operation type local service. Add custom service methods to {@link cmr.fandenatech.ndjangui.service.impl.OperationTypeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
