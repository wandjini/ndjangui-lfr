 ...
 * @generated
 */
public abstract class OperationActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public OperationActionableDynamicQuery() throws SystemException {
		setBaseLocalService(OperationLocalServiceUtil.getService());
		setClass(Operation.class);

		setClassLoader(cmr.fandenatech.ndjangui.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("operationId");
	}
}