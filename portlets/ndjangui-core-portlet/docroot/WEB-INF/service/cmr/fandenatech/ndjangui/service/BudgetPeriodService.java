...
/**
 * Provides the remote service interface for BudgetPeriod. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author guyw
 * @see BudgetPeriodServiceUtil
...
public interface BudgetPeriodService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BudgetPeriodServiceUtil} to access the budget period remote service. Add custom service methods to {@link cmr.fandenatech.ndjangui.service.impl.BudgetPeriodServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
