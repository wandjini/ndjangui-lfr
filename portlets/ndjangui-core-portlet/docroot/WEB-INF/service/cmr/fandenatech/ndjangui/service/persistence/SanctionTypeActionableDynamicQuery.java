 ...
 * @generated
 */
public abstract class SanctionTypeActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public SanctionTypeActionableDynamicQuery() throws SystemException {
		setBaseLocalService(SanctionTypeLocalServiceUtil.getService());
		setClass(SanctionType.class);

		setClassLoader(cmr.fandenatech.ndjangui.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("sanctionTypeId");
	}
}