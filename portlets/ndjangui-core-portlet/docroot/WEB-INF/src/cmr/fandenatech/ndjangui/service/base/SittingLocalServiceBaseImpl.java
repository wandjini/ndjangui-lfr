...
import cmr.fandenatech.ndjangui.service.SittingLocalService;
...
/**
 * Provides the base implementation for the sitting local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link cmr.fandenatech.ndjangui.service.impl.SittingLocalServiceImpl}.
 * </p>
 *
 * @author guyw
 ...
 * @generated
 */
public abstract class SittingLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SittingLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link cmr.fandenatech.ndjangui.service.SittingLocalServiceUtil} to access the sitting local service.
	 */
	...
	@Override
	public Sitting addSitting(Sitting sitting) throws SystemException {
		sitting.setNew(true);

		return sittingPersistence.update(sitting);
	}
	 ...
	 */
	@Override
	public Sitting createSitting(long sittingId) {
		return sittingPersistence.create(sittingId);
	}
	...
	@Override
	public Sitting deleteSitting(long sittingId)
		throws PortalException, SystemException {
		return sittingPersistence.remove(sittingId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Sitting deleteSitting(Sitting sitting) throws SystemException {
		return sittingPersistence.remove(sitting);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Sitting.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return sittingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return sittingPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return sittingPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return sittingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return sittingPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Sitting fetchSitting(long sittingId) throws SystemException {
		return sittingPersistence.fetchByPrimaryKey(sittingId);
	}
	 ...
	 */
	@Override
	public Sitting getSitting(long sittingId)
		throws PortalException, SystemException {
		return sittingPersistence.findByPrimaryKey(sittingId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return sittingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Sitting> getSittings(int start, int end)
		throws SystemException {
		return sittingPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSittingsCount() throws SystemException {
		return sittingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Sitting updateSitting(Sitting sitting) throws SystemException {
		return sittingPersistence.update(sitting);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("cmr.fandenatech.ndjangui.model.Sitting",
			sittingLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = sittingPersistence.getDataSource();
	...
	private SittingLocalServiceClpInvoker _clpInvoker = new SittingLocalServiceClpInvoker();
}