...
import cmr.fandenatech.ndjangui.service.SanctionLocalService;
...
/**
 * Provides the base implementation for the sanction local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link cmr.fandenatech.ndjangui.service.impl.SanctionLocalServiceImpl}.
 * </p>
 *
 * @author guyw
 ...
 * @generated
 */
public abstract class SanctionLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SanctionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link cmr.fandenatech.ndjangui.service.SanctionLocalServiceUtil} to access the sanction local service.
	 */
	...
	@Override
	public Sanction addSanction(Sanction sanction) throws SystemException {
		sanction.setNew(true);

		return sanctionPersistence.update(sanction);
	}
	 ...
	 */
	@Override
	public Sanction createSanction(long sanctionId) {
		return sanctionPersistence.create(sanctionId);
	}
	...
	@Override
	public Sanction deleteSanction(long sanctionId)
		throws PortalException, SystemException {
		return sanctionPersistence.remove(sanctionId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Sanction deleteSanction(Sanction sanction) throws SystemException {
		return sanctionPersistence.remove(sanction);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Sanction.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return sanctionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return sanctionPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return sanctionPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return sanctionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Sanction fetchSanction(long sanctionId) throws SystemException {
		return sanctionPersistence.fetchByPrimaryKey(sanctionId);
	}
	...
	public Sanction getSanction(long sanctionId)
		throws PortalException, SystemException {
		return sanctionPersistence.findByPrimaryKey(sanctionId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return sanctionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Sanction> getSanctions(int start, int end)
		throws SystemException {
		return sanctionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getSanctionsCount() throws SystemException {
		return sanctionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Sanction updateSanction(Sanction sanction) throws SystemException {
		return sanctionPersistence.update(sanction);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("cmr.fandenatech.ndjangui.model.Sanction",
			sanctionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = sanctionPersistence.getDataSource();
	...
	private SanctionLocalServiceClpInvoker _clpInvoker = new SanctionLocalServiceClpInvoker();
}