...
import cmr.fandenatech.ndjangui.NoSuchAddressException;
import cmr.fandenatech.ndjangui.model.Address;
import cmr.fandenatech.ndjangui.model.impl.AddressImpl;
import cmr.fandenatech.ndjangui.model.impl.AddressModelImpl;
...
public class AddressPersistenceImpl extends BasePersistenceImpl<Address>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			AddressModelImpl.FINDER_CACHE_ENABLED, AddressImpl.class,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPID = new FinderPath(AddressModelImpl.ENTITY_CACHE_ENABLED,
			AddressModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Address> findByGroupId(long groupId) throws SystemException {
	 ...
	 */
	@Override
	public List<Address> findByGroupId(long groupId, int start, int end)
	 ...
	 */
	@Override
	public Address findByGroupId_First(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchAddressException, SystemException {
		Address address = fetchByGroupId_First(groupId, orderByComparator);
	 ...
	 */
	@Override
	public Address fetchByGroupId_First(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Address> list = findByGroupId(groupId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Address findByGroupId_Last(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchAddressException, SystemException {
		Address address = fetchByGroupId_Last(groupId, orderByComparator);
	 ...
	 */
	@Override
	public Address fetchByGroupId_Last(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Address> list = findByGroupId(groupId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Address[] findByGroupId_PrevAndNext(long addressId, long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchAddressException, SystemException {
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(session, address, groupId,
					orderByComparator, true);

			array[1] = address;

			array[2] = getByGroupId_PrevAndNext(session, address, groupId,
	...
	protected Address getByGroupId_PrevAndNext(Session session,
		Address address, long groupId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByGroupId(long groupId) throws SystemException {
		for (Address address : findByGroupId(groupId, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_GROUPID_GROUPID_2 = "address.groupId = ?";
	...
	@Override
	public Address updateImpl(cmr.fandenatech.ndjangui.model.Address address)
		throws SystemException {
		address = toUnwrappedModel(address);
		...
		if (isNew || !AddressModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((addressModelImpl.getColumnBitmask() &
				...
				args = new Object[] { addressModelImpl.getGroupId() };
	...
	protected Address toUnwrappedModel(Address address) {
		...
		addressImpl.setTown(address.getTown());
		addressImpl.setNote(address.getNote());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.cmr.fandenatech.ndjangui.model.Address")));
