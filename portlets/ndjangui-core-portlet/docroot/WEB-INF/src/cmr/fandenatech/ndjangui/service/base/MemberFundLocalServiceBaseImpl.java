...
import cmr.fandenatech.ndjangui.service.MemberFundLocalService;
...
/**
 * Provides the base implementation for the member fund local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link cmr.fandenatech.ndjangui.service.impl.MemberFundLocalServiceImpl}.
 * </p>
 *
 * @author guyw
 ...
 * @generated
 */
public abstract class MemberFundLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MemberFundLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link cmr.fandenatech.ndjangui.service.MemberFundLocalServiceUtil} to access the member fund local service.
	 */
	...
	@Override
	public MemberFund addMemberFund(MemberFund memberFund)
		throws SystemException {
		memberFund.setNew(true);

		return memberFundPersistence.update(memberFund);
	}
	 ...
	 */
	@Override
	public MemberFund createMemberFund(long memberFundId) {
		return memberFundPersistence.create(memberFundId);
	}
	...
	@Override
	public MemberFund deleteMemberFund(long memberFundId)
		throws PortalException, SystemException {
		return memberFundPersistence.remove(memberFundId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MemberFund deleteMemberFund(MemberFund memberFund)
		throws SystemException {
		return memberFundPersistence.remove(memberFund);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MemberFund.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return memberFundPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return memberFundPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return memberFundPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public MemberFund fetchMemberFund(long memberFundId)
		throws SystemException {
		return memberFundPersistence.fetchByPrimaryKey(memberFundId);
	}
	 ...
	 */
	@Override
	public MemberFund getMemberFund(long memberFundId)
		throws PortalException, SystemException {
		return memberFundPersistence.findByPrimaryKey(memberFundId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return memberFundPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MemberFund> getMemberFunds(int start, int end)
		throws SystemException {
		return memberFundPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getMemberFundsCount() throws SystemException {
		return memberFundPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MemberFund updateMemberFund(MemberFund memberFund)
		throws SystemException {
		return memberFundPersistence.update(memberFund);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("cmr.fandenatech.ndjangui.model.MemberFund",
			memberFundLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = memberFundPersistence.getDataSource();
	...
	private MemberFundLocalServiceClpInvoker _clpInvoker = new MemberFundLocalServiceClpInvoker();
}