...
import cmr.fandenatech.ndjangui.service.MemberLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link cmr.fandenatech.ndjangui.service.impl.MemberLocalServiceImpl}.
 * </p>
 *
 * @author guyw
 ...
 * @generated
 */
public abstract class MemberLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements MemberLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link cmr.fandenatech.ndjangui.service.MemberLocalServiceUtil} to access the member local service.
	 */
	...
	@Override
	public Member addMember(Member member) throws SystemException {
		member.setNew(true);
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Member deleteMember(Member member) throws SystemException {
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Member.class,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return memberPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Member fetchMember(long memberId) throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Member updateMember(Member member) throws SystemException {
		return memberPersistence.update(member);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("cmr.fandenatech.ndjangui.model.Member",
			memberLocalService);
	}
	...
	private MemberLocalServiceClpInvoker _clpInvoker = new MemberLocalServiceClpInvoker();
}