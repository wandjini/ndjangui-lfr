...
import cmr.fandenatech.ndjangui.service.FundTypeLocalService;
...
/**
 * Provides the base implementation for the fund type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link cmr.fandenatech.ndjangui.service.impl.FundTypeLocalServiceImpl}.
 * </p>
 *
 * @author guyw
 ...
 * @generated
 */
public abstract class FundTypeLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements FundTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link cmr.fandenatech.ndjangui.service.FundTypeLocalServiceUtil} to access the fund type local service.
	 */
	...
	@Override
	public FundType addFundType(FundType fundType) throws SystemException {
		fundType.setNew(true);

		return fundTypePersistence.update(fundType);
	}
	 ...
	 */
	@Override
	public FundType createFundType(long fundTypeId) {
		return fundTypePersistence.create(fundTypeId);
	}
	...
	public FundType deleteFundType(long fundTypeId)
		...
		return fundTypePersistence.remove(fundTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FundType deleteFundType(FundType fundType) throws SystemException {
		return fundTypePersistence.remove(fundType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FundType.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return fundTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return fundTypePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return fundTypePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return fundTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public FundType fetchFundType(long fundTypeId) throws SystemException {
		return fundTypePersistence.fetchByPrimaryKey(fundTypeId);
	}
	 ...
	 */
	@Override
	public FundType getFundType(long fundTypeId)
		throws PortalException, SystemException {
		return fundTypePersistence.findByPrimaryKey(fundTypeId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return fundTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FundType> getFundTypes(int start, int end)
		throws SystemException {
		return fundTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getFundTypesCount() throws SystemException {
		return fundTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FundType updateFundType(FundType fundType) throws SystemException {
		return fundTypePersistence.update(fundType);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("cmr.fandenatech.ndjangui.model.FundType",
			fundTypeLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = fundTypePersistence.getDataSource();
	...
	private FundTypeLocalServiceClpInvoker _clpInvoker = new FundTypeLocalServiceClpInvoker();
}