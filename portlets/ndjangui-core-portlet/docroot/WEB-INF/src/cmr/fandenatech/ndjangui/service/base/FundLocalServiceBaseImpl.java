...
import cmr.fandenatech.ndjangui.service.FundLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link cmr.fandenatech.ndjangui.service.impl.FundLocalServiceImpl}.
 * </p>
 *
 * @author guyw
...
public abstract class FundLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link cmr.fandenatech.ndjangui.service.FundLocalServiceUtil} to access the fund local service.
	 */
	...
	@Override
	public Fund addFund(Fund fund) throws SystemException {
		fund.setNew(true);
	...
	@Override
	public Fund deleteFund(long fundId) throws PortalException, SystemException {
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Fund deleteFund(Fund fund) throws SystemException {
	...
	@Override
	public Fund fetchFund(long fundId) throws SystemException {
	 ...
	 */
	@Override
	public Fund getFund(long fundId) throws PortalException, SystemException {
	 ...
	 */
	@Override
	public List<Fund> getFunds(int start, int end) throws SystemException {
	 ...
	 */
	@Override
	public int getFundsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Fund updateFund(Fund fund) throws SystemException {
		return fundPersistence.update(fund);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("cmr.fandenatech.ndjangui.model.Fund",
			fundLocalService);
	}
