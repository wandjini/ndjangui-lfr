...
import cmr.fandenatech.ndjangui.service.OperationLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link cmr.fandenatech.ndjangui.service.impl.OperationLocalServiceImpl}.
 * </p>
 *
 * @author guyw
...
public abstract class OperationLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements OperationLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link cmr.fandenatech.ndjangui.service.OperationLocalServiceUtil} to access the operation local service.
	 */
	 ...
	 */
	@Override
	public Operation createOperation(long operationId) {
		return operationPersistence.create(operationId);
	}
	...
	public Operation deleteOperation(long operationId)
		...
		return operationPersistence.remove(operationId);
	}
	...
	@Override
	public Operation fetchOperation(long operationId) throws SystemException {
		return operationPersistence.fetchByPrimaryKey(operationId);
	}
	...
	public Operation getOperation(long operationId)
		throws PortalException, SystemException {
		return operationPersistence.findByPrimaryKey(operationId);
	}
	 ...
	 */
	@Override
	public int getOperationsCount() throws SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("cmr.fandenatech.ndjangui.model.Operation",
	...
	private OperationLocalServiceClpInvoker _clpInvoker = new OperationLocalServiceClpInvoker();
}